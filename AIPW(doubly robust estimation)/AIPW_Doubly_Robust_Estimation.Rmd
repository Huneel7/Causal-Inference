...
pre_data <- defData(pre_data, varname = "L2", formula = "0.7 + 1.7*L1", 
                dist = "normal")

pre_data <- defData(pre_data, varname = "A", formula = "0.17 + 0.37*L1",
                dist = "binary", link = "logit")

pre_data <- defData(pre_data, varname = "Y", formula = "2*A + L2", 
                dist = "nonrandom")

pre_data <- defData(pre_data, varname = "Y2", formula = "2*A + L2 + A^2 + L2^2", 
                dist = "nonrandom")
