...
Here the goal is to show that $E[\phi(Z;\overline{\pi},\overline{\mu},\psi)] = 0$ if either $\overline{\pi} = \pi$ or $\overline{\mu} = \mu$, where $\phi(Z;\overline{\pi},\overline{\mu},\psi)$ is the influence function defined as in the main text as 
...
$E\big[\phi(Z;\overline{\pi},\overline{\mu}) \mid A=a\big]$
...
where the first equality follows by definition, the second equality follow by iterated expectation