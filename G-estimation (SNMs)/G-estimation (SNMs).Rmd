...
For the search must be conducted over a two-dimensional space, this grid search is computationally demanding. Less computationally intensive approaches, known as directed search methods, for approximate search- ing are available in statistical software.
